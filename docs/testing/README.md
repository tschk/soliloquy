...
The macOS smoke path checks the UI, compiles the non-GPUI desktop path, and dry-runs the `sold` plus Servo launch contract. It is intended for pre-launch validation and does not keep a GUI process open.
